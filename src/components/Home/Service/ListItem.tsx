...
const HomeServiceListItem = ({ data }: HomeServiceListItemProps) => (
  <HomeNewsItemContainer data={data} className="flex-row md:flex-col" imageClassName="w-28 md:w-full">
    <div className="px-4 py-4 md:px-6 md:py-5">
      <h3 className="font-semibold">{data.name}</h3>
      <p className="line-clamp-2 border-gray-100 pt-2 md:mt-4 md:line-clamp-3 md:border-t-2 md:pt-4">
